            ...
            <div class="container">
                    ...
                    <div class="progress">
                        ...
                        <ul class="progress-steps">
                            <li class="step active">
                                <span>1</span>
                                <p>Personal Info<br><span>Tell Us Who You Are</span></p>
                            </li>
                            <li class="step">
                                <span>2</span>
                                <p>Delivery Details<br><span>Tell Us Where To Deliver</span></p>
                            </li>
                            <li class="step">
                                <span>3</span>
                                <p>Payment<br><span>Proceed To Pay</span></p>
                            </li>
                        </ul>
                    </div>
                    <form action="">
                        <div class="form-one form-step active">
                            ...
                            <div>
                                ...
                                <input type="text" placeholder="e.g Wick">
                            </div>
                            <div class="email">
                                <label>Email</label>
                ...
                <option value="Zimbabwe">Zimbabwe</option>
                        ...
                        <div class="form-three form-step">
                            <div class="bg-svg"></div>
                            <h2>Payment</h2>
                            <p>Please Scan The QR Code To Proceed Checkout</p>
                            <div>

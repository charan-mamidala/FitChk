...
<body>
    ...
    <section id="about-head" class="section-p1">
        <img src="Images/Banners/a6.jpg">
        <div>
            <h2>Who Are We?</h2>
            <p> Welcome to FitChk, where fashion meets function in perfect harmony. We are more than just a clothing
                brand; we're a lifestyle movement dedicated to
                empowering individuals to embrace their unique style while prioritizing comfort and versatility.
            <p></p>

            At FitChk, we believe that looking good should never come at the expense of feeling good. That's why each
            piece in our collection is meticulously designed
            with both style and performance in mind. Whether you're hitting the gym, lounging at home, or exploring the
            city streets, our apparel is tailored to keep up
            with your active lifestyle.<br>
            We aim to provide you with a wide variety of clothing apparels ranging from your casual wear to formal
            clothing. Our Developers; Sai Praneeth, S. Nashwitha
            and M. Charan aspire to tend to all your needs when browsing through this virtual closet. Our customer
            service is available 24x7 and is always ready to attend
            to your concerns. With exciting Offers and Sales that carry on throughout the year, we hope to be able to
            fulfil all your needs regarding your wardrobe. <p></p>

            We celebrate diversity, inclusivity, and self-expression, because we know that true style knows no
            boundaries.
            Join us on this journey as we redefine what it means to be fashion-forward and fitness-ready where every
            outfit is a statement, and every moment is an
            opportunity to shine.
            </p>
        </div>
    </section>

    <section id="shopping-ad" class="section-p1">

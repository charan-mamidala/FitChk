...
<body>
    ...
    <section id="product1" class="section-p1">
        ...
        <p> Summer Collection Is Now For Sale! </p>
                        ...
                        <div class="products">
                            <div class="box-container">
                                ...
                                if (isset($_GET['brand'])) {
                                    ...
                                    $select_product = mysqli_query($conn, "SELECT * FROM products WHERE brand = '$brand_title' ") or die('query failed');
                                    // $result_brands = mysqli_fetch_assoc($select_product);
                                    if (mysqli_num_rows($select_product) > 0) {
                                        while ($fetch_product = mysqli_fetch_assoc($select_product)) {
                                            ?>
                                            <form method="post" class="box" action="">
                                                ...
                                                <div class="qty-btn">
                                                    <input type="number" min="1" name="product_quantity" value="1">
                                                    <a href="view_detail.php?pid=<?php echo $fetch_product['id']; ?>"
                                                        class="add"><ion-icon name="eye"></ion-icon></a>
                                                    <button class="btn" name="add_to_cart"> <i onclick="location.href='cart.php'"
                                                            class='bx bxs-cart-alt' id="cart-icon"></i></button>
                                                </div>
                                                ...
                                                <input type="hidden" name="product_brand"
                                                    value="<?php echo $fetch_product['brand']; ?>">
                                                <input type="hidden" name="product_category"
                                                    value="<?php echo $fetch_product['category']; ?>">
                                            </form>
                                            <?php
                                        }
                                        ;
                    ...
                    <div class="container">
                        <div class="products">
                            <div class="box-container">
                                <?php
                                if (isset($_GET['category'])) {
                                    // echo $test = "SELECT * FROM products WHERE category = '" .$_GET['category']."'";
                                    $select_product = mysqli_query($conn, "SELECT * FROM products WHERE category = '" . $_GET['category'] . "' ") or die('query failed');
                                    // $result_brands = mysqli_fetch_assoc($select_product);
                                    if (mysqli_num_rows($select_product) > 0) {
                                        while ($fetch_product = mysqli_fetch_assoc($select_product)) {
                                            ?>
    ...
    <section id="banner" class="section-m1">
        <h2>Upto <span> 60% OFF </span> On Apparels!</h2>
        <br>
    ...
    <section id="sm-banner" class="section-p1">
        <div class="banner-box">
            ...
            <span> Best Sellers Are Back! </span>
            <button class="white"> Learn More </button>
        </div>
        <div class="banner-box banner-box2">
            <h4> On Demand! </h4>
            <h2>Checkout Our Newest <br>CHILL Collection!</h2>
            <span> Click Below to Explore! </span>
    ...
    <section id="banner3">
        <div class="banner-box">
            <h2>SEASONAL SALE</h2>
            <h3 style="font-size: 30px;">Summer Collection -40% OFF</h3>
        </div>
        <div class="banner-box banner-box2">
            <h2>NEW FOOTWEAR COLLECTION</h2>
            <h3 style="font-size: 30px;">Crazy Offers at Crazy Prices!</h3>
        </div>
        <div class="banner-box banner-box3">
            <h2>T-SHIRTS</h2>
            <h3 style="font-size: 30px;"> New Drops</h3>
        </div>
    </section>
    <!-- BANNERS END -->
